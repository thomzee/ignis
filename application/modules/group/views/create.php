<form action="<?php echo $slug . '/store' ?>" method="post">
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group <?php form_error('description') ? print 'has-error' : '' ?>">
                    ...
                    <textarea rows="5" class="form-control" name="description" placeholder="<?php echo lang('description') ?>"><?php echo set_value('description'); ?></textarea>
                    <span class="help-block">
